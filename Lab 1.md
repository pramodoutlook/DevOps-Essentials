...
* Use tag Name: `PS-Jump-Server`
* AMI Type and OS Version: `Ubuntu 22.04 LTS`
* Instance type: `t2.micro`
* Create key pair with name: `PS-DevOps-Keypair`
* Create security group with name: `PS-DevOps-SG`
...
variable key_name {
    default = "PS-Jenkins-Docker-KeyPair"
}
...
variable "my-servers" {
  type    = list(string)
  default = ["PS-Jenkins-Server", "PS-Docker-Server"]
}
```
